            ...
            const ClashPanel(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Session authority signs start_round and settle_round while active.',
                  ),
                  SizedBox(height: 8),
                  Text(
                    'Remaining spend limit and expiration timer will read PlayerSession once IDL decoding is wired.',
                  ),
                ],
              ),
            ),
                ...
                return ClashPanel(
                  child: Column(
                    ...
                    children: [
                      ...
                      SelectableText(
                        path,
                        style: const TextStyle(color: clashGreen, fontSize: 12),
                      ),
                    ],
                  ),
                );
